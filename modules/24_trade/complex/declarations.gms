...
p24_MportsRegi_iter(iteration,tall,all_regi,all_regi,tradeSe)     "parameter to save p24_MportsRegi across iterations"
p24_XportsRegi_iter(iteration,tall,all_regi,all_regi,tradeSe)     "parameter to save p24_XportsRegi across iterations"
pm_MPortsPrice_iter(iteration,tall,all_regi,tradeSe)              "parameter to save pm_MPortsPrice across iterations"
pm_XPortsPrice_iter(iteration,tall,all_regi,tradeSe)              "parameter to save pm_XPortsPrice across iterations"
pm_SEPriceseel_iter(iteration,tall,all_regi)                      "parameter to save pm_SEPrice for seel across iterations"
;
