...
$elseif.seTradeScenario "%cm_seTradeScenario%" == "DEU_Ultra_H2"
  p24_seTradeCapacity("2030",regi,regi2,"seh2")$(sameas(regi,"MEA") AND sameas(regi2,"DEU")) = 300/8760;
  p24_seTradeCapacity("2035",regi,regi2,"seh2")$(sameas(regi,"MEA") AND sameas(regi2,"DEU")) = 500/8760;
  p24_seTradeCapacity("2040",regi,regi2,"seh2")$(sameas(regi,"MEA") AND sameas(regi2,"DEU")) = 800/8760;
  p24_seTradeCapacity("2045",regi,regi2,"seh2")$(sameas(regi,"MEA") AND sameas(regi2,"DEU")) = 1000/8760;
  p24_seTradeCapacity("2050",regi,regi2,"seh2")$(sameas(regi,"MEA") AND sameas(regi2,"DEU")) = 2000/8760;
  p24_seTradeCapacity(t,regi,regi2,"seh2")$(sameas(regi,"MEA") AND sameas(regi2,"DEU") AND t.val ge 2055) = 5000/8760;
$elseif.seTradeScenario "%cm_seTradeScenario%" == "DEU_Free_H2"
  p24_seTradeCapacity(t,regi,regi2,"seh2")$(sameas(regi,"MEA") AND sameas(regi2,"DEU") AND t.val ge 2025) = 10000/8760;
