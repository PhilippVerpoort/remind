...
qm_budget(ttot,regi)$( ttot.val ge cm_startyear ) .. 
  ...
  + sum(tradePoolPE(enty)), pm_costsTradePeFinancial(regi,"Mport",enty) * vm_Mport(ttot,regi,enty))
  + sum(tradePoolPE(enty)),
  ...
  + sum(tradeBilat, vm_costTradeCap(ttot,regi,tradeBilat))
